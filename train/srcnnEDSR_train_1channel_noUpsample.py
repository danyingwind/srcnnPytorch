...
if __name__ == '__main__':
    ...
    best_epoch = 0
    best_psnr = 0.0
    writer = SummaryWriter('/home/wangdanying/SRCNN/srcnnPytorch/debug/tensorLog/EDSR_1channel_noUpsample')
    ...
    for epoch in range(args.num_epochs):
        ...
        writer.add_scalar("EDSR_1channel_noUpsample", epoch_psnr.avg, epoch)
