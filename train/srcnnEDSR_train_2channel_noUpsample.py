...
if __name__ == '__main__':
    ...
    writer = SummaryWriter('/home/wangdanying/SRCNN/srcnnPytorch/debug/tensorLog/EDSR_2channel_noUpsample')
    ...
    for epoch in range(args.num_epochs):
        ...
        writer.add_scalar("srcnnEDSR_train_2channel_noUpsample", epoch_psnr.avg, epoch)
