...
def make_path2(input_paths):
    ...
    for input_path in input_paths:
        ...
        for key in folder_list.keys():
            output_path = ""
            input_path_parts.insert(6,key)
            for t in input_path_parts:
                output_path = os.path.join(output_path, t)
            output_path = '/' + output_path
            folder_list[key].append(output_path)
...
if __name__ == '__main__':
    ...
    output_path = make_path2(lr_tex_yuv_path)
